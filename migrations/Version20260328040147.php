 ...
 */
final class Version20260328040147 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE interaction_threads (id INT AUTO_INCREMENT NOT NULL, subject VARCHAR(191) DEFAULT NULL, status VARCHAR(100) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE response_types (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, description LONGTEXT DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE organization_contact_interactions ADD thread_id INT DEFAULT NULL, ADD response_type_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_C3C27699E2904019 ON organization_contact_interactions (thread_id)');
        $this->addSql('CREATE INDEX IDX_C3C276996EF6CAED ON organization_contact_interactions (response_type_id)');
        ...
        $this->addSql('ALTER TABLE person_contact_interactions ADD thread_id INT DEFAULT NULL, ADD response_type_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_9B7AEBDDE2904019 ON person_contact_interactions (thread_id)');
        $this->addSql('CREATE INDEX IDX_9B7AEBDD6EF6CAED ON person_contact_interactions (response_type_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE interaction_threads');
        $this->addSql('DROP TABLE response_types');
        ...
        $this->addSql('DROP INDEX IDX_C3C27699E2904019 ON organization_contact_interactions');
        $this->addSql('DROP INDEX IDX_C3C276996EF6CAED ON organization_contact_interactions');
        $this->addSql('ALTER TABLE organization_contact_interactions DROP thread_id, DROP response_type_id');
        ...
        $this->addSql('DROP INDEX IDX_9B7AEBDDE2904019 ON person_contact_interactions');
        $this->addSql('DROP INDEX IDX_9B7AEBDD6EF6CAED ON person_contact_interactions');
        $this->addSql('ALTER TABLE person_contact_interactions DROP thread_id, DROP response_type_id');
