 ...
 */
final class Version20260325004844 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE organizations (id INT AUTO_INCREMENT NOT NULL, legal_name VARCHAR(191) NOT NULL, trade_name VARCHAR(191) DEFAULT NULL, cnpj VARCHAR(18) NOT NULL, email VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_427C1C7FC8C6906B (cnpj), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE persons (id INT AUTO_INCREMENT NOT NULL, full_name VARCHAR(191) NOT NULL, cpf VARCHAR(14) NOT NULL, email VARCHAR(191) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_A25CC7D33E3E11F0 (cpf), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
