 ...
 */
final class Version20260325233812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE organization_contacts ADD deactivated_at DATETIME DEFAULT NULL, ADD deactivation_reason LONGTEXT DEFAULT NULL, ADD status_id INT DEFAULT NULL, ADD issue_type_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_DC58D7D16BF700BD ON organization_contacts (status_id)');
        $this->addSql('CREATE INDEX IDX_DC58D7D160B4C972 ON organization_contacts (issue_type_id)');
        ...
        $this->addSql('ALTER TABLE person_contacts ADD deactivated_at DATETIME DEFAULT NULL, ADD deactivation_reason LONGTEXT DEFAULT NULL, ADD status_id INT DEFAULT NULL, ADD issue_type_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_A706B0446BF700BD ON person_contacts (status_id)');
        $this->addSql('CREATE INDEX IDX_A706B04460B4C972 ON person_contacts (issue_type_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_DC58D7D16BF700BD ON organization_contacts');
        $this->addSql('DROP INDEX IDX_DC58D7D160B4C972 ON organization_contacts');
        $this->addSql('ALTER TABLE organization_contacts DROP deactivated_at, DROP deactivation_reason, DROP status_id, DROP issue_type_id');
        ...
        $this->addSql('DROP INDEX IDX_A706B0446BF700BD ON person_contacts');
        $this->addSql('DROP INDEX IDX_A706B04460B4C972 ON person_contacts');
        $this->addSql('ALTER TABLE person_contacts DROP deactivated_at, DROP deactivation_reason, DROP status_id, DROP issue_type_id');
